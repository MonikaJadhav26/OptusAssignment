...
class CityDetailViewModel : NSObject {
    ...
    func getAllWeatherDetailsArray(isCelcius : Bool) -> [Dictionary<String, String>]  {
        ...
        weatherDeatils.append(["VISIBILITY": Formatters.Visibility.string(from: self.city[0].visibility ?? Int(0.0))])
    ...
    func getAllWeatherIconArray() -> [Dictionary<String, UIImage>]  {
        ...
        weatherIcons.append(["DEGREETEMP": (UIImage(named: "maximum")!)])
        ...
        weatherIcons.append(["VISIBILITY": (UIImage(named: "visibility")!)])
